...
Client company = (Client)request.getAttribute("company");
	...
	<div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <i class="fa fa-users"></i> クライアント管理
          </h1>
        </section>
            ...
            <div class="col-md-3">
              ...
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <div class='box-tools'>
                    <a class='btn btn-box-tool' href="/company/client/editInfo?company=<%=company.getKey().getName() %>" style="font-size: 14px"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                  </div>
                </div>
                <div class="box-body">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a><i class="fa fa-database" aria-hidden="true"></i> <%=company.getKey().getName() %></a></li>
                    <li><a><i class="fa fa-user" aria-hidden="true"></i> <%=company.getName() %></a></li>
                    <li><a><i class="fa fa-tags" aria-hidden="true"></i> <%=company.getIndustry().getName() %></a></li>
                    <li>
              ...
              <a href="/project/add?client=<%=company.getKey().getName() %>" class="btn btn-primary btn-block margin-bottom">プロジェクトの登録</a>
