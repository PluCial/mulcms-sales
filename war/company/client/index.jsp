...
List<Client> companyList = (List<Client>)request.getAttribute("companyList");
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            ...
            <jsp:include page="/includes/client_left_content.jsp" />
            <!-- partner left content -->
            
            <div class="col-md-9">
              <div class="box box-primary" style="z-index: 1;">
                <div class="box-header with-border">
                  <h3 class="box-title">クライアント一覧</h3>
                  ...
                  <div class="table-responsive mailbox-messages" style="overflow-x: visible !important;overflow-y: visible !important;">
                    <table class="table table-hover table-striped">
                      <tbody>
                      	...
                      	%>
                        <tr>
                          <td class="mailbox-name"><a href="/company/client/info?company=<%=company.getKey().getName() %>"><%=company.getName() %></a></td>
